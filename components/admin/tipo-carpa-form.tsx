  ...
  return (
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <AdminPanel
        ...
        description="Nombre, dirección y foto del tipo de carpa."
      >
      ...
      <AdminPanel
        ...
        description="Medidas, capacidad, material y usos que se muestran en el catálogo."
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Field
