  ...
  return (
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <AdminPanel
        ...
        description="Título, dirección de la página y estado de publicación."
      >
      ...
      <AdminPanel
        eyebrow="Detalle del montaje"
        title="Ficha técnica"
        description="Se muestra en el detalle del proyecto; los campos vacíos se omiten."
      >
        <div className="grid gap-4 sm:grid-cols-2">
      ...
      <AdminPanel
        eyebrow="Relato"
        title="Descripción y destacado"
        description="Texto del proyecto y si aparece en la portada."
      >
        ...
        <label className="flex w-fit cursor-pointer items-center gap-2.5 rounded-xl border border-border bg-bone-alt px-4 py-2.5 text-sm">
          <input
            type="checkbox"
            name="destacado"
